...
A. 별도 플러그인 레포([mailman-plugin](https://github.com/thewronghand-bigs/mailman-plugin))를 설치하면 `@mailman`으로 쓸 수 있어요.
...
- Codex Desktop 플러그인: [mailman-plugin](https://github.com/thewronghand-bigs/mailman-plugin)
