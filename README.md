...
A. [mailman-plugin](https://github.com/thewronghand-bigs/mailman-plugin) 설치하세요.
...
```bash
curl -fsSL https://raw.githubusercontent.com/thewronghand-bigs/mailman/main/uninstall.sh | bash
```

수집 데이터(DB, Chrome 프로필)는 자동 삭제되지 않습니다. 안내에 따라 직접 삭제하세요.
